      ...
      <ContentContainer>
        ...
        <View style={styles.contentArea}>
          ...
          <Text style={styles.descriptionText}>
            Your data is completely anonymized and securely encrypted. QuranChat
            respects your privacy. Your personal information will never be
            shared or stored in a way that identifies you.
          </Text>
